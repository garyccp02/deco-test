...
#[derive(Debug)]
pub struct KeyExchangeResult { // cancel crate
    pub(crate) pubkey: ring::agreement::PublicKey,
    pub shared_secret: Vec<u8>, // cancel crate
}

/// An in-progress key exchange.  This has the algorithm,
/// our private key, and our public key.
#[derive(Clone, Debug)] // ADDED
pub struct KeyExchange { // delete pub(crate)
...
impl KeyExchange {
    ...
    pub fn complete(self, peer: &[u8]) -> Option<KeyExchangeResult> { // cancel crate
