curl -L services.clp.com.hk/en/dashboard/index.aspx --cookie-jar ./rustls/src/cookie.txt 'https://services.clp.com.hk/Service/ServiceLogin.ashx' \
  ...
  --data-raw 'username=20845600850&password=Sarnak17%23%23&rememberMe=false&loginPurpose=&magentoToken=&domeoId=&domeoPointsBalance=&domeoPointsNeeded=' \
  --compressed